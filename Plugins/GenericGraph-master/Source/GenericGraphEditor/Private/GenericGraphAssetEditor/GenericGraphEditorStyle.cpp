...
void FGenericGraphEditorStyle::Initialize()
{
	...
	StyleSet->SetContentRoot(FPaths::ProjectPluginsDir() / TEXT("GenericGraph-master/Resources"));
	...
	StyleSet->Set("GenericGraphEditor.AddGraphTemplate", new IMAGE_BRUSH("AddGraphTemplate", Icon40x40));
	StyleSet->Set("GenericGraphEditor.AddGraphTemplate.Small", new IMAGE_BRUSH( "AddGraphTemplate", Icon20x20 ) );

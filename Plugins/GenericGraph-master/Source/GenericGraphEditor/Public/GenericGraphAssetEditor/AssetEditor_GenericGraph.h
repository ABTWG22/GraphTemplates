...
public:
	...
	UEdGraphNode* AddNewNodeToGraph(const FString& DesiredNodeTitle, UEdGraph* Graph, UEdGraphPin* FromPin, const FVector2D Location, bool bSelectNewNode) const;
...
protected:
	...
	void AddGraphTemplate();
	bool CanAddGraphTemplate() const;
